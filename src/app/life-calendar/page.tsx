                ...
                cells.push(
                    <div
                        ...
                        className={`
                            ...
                            ${isPast ? 'bg-yellow-100' : 'bg-gray-100'}
                    ...
                    >
                        <div className="absolute top-0 left-0 text-[8px] text-gray-400 px-1 bg-white/50 rounded-br-sm z-10">
                            {year}
                        </div>
                        {isEditing ? (
                            <textarea
                                className="w-full h-full p-1.5 text-xs resize-none focus:outline-none pt-4 bg-transparent"
                                value={editContent}
                            ...
                            <div className="w-full h-full p-1.5 overflow-auto pt-4">
                                <div className="text-xs prose prose-sm max-w-none break-words">
                                    <ReactMarkdown
